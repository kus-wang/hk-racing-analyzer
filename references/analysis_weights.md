...
> 最后更新：2026-04-02（进化建议1/2/4应用后）

| 维度 | 子维度 | 权重 | 变化 | 说明 |
|------|--------|------|------|------|
| **历史战绩** | 同距离+同场地近5场 | **16%** | ↓ -2% | 降低过拟合；支持时间衰减加权（v1.4.3）|
| | 同场地（不限距离）近5场 | **18%** | ↑ +5% | 场地适应性参考；配速释放5%补入 |
| | 班次适配度（评分与班次匹配） | **8%** | — | 升班/降班对竞争力的影响 |
| **赔率** | 临场赔率绝对值 | **15%** | — | 反映市场当前预期 |
| | 赔率走势（开盘→临场变化幅度） | **15%** | ↑ +2% | 反映资金流向，市场信号更受重视 |
| **配速/分段** | 配速指数（后段冲刺能力）| **10%** | ↓ -5% | ⚠️ 临时降权（缺实测数据），待接入后恢复15% |
| **骑师** | — | **5%** | — | 基于历史战绩中骑师×本马的胜率/前3率动态计算 |
| **练马师** | — | **4%** | — | 基于历史战绩中练马师×本马的胜率/前3率动态计算 |
| **档位** | — | **5%** | — | 同距离档位胜率统计 |
| **HKJC贴士指数** | — | **6%** | — | 官方每日贴士指数（市场共识，高于外部专家） |
| **外部专家预测** | — | **4%** | — | 多位专家共识度，降权处理 |
| **合计** | | — | | |
